...
export const CHAR_STAT_TARGETS = {
  ...
  // ── SWEEPER / ASSASSIN ──
  'Joker':           {atk:[120,25], crit:[40,18], cdmg:[190,15], dmgMulti:[35,12], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0],   spr:[0,0],   ailm:[0,0]},
  'Panther':         {atk:[110,20], crit:[40,18], cdmg:[0,0],   dmgMulti:[50,22], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Skull':           {atk:[110,22], crit:[42,20], cdmg:[260,22], dmgMulti:[30,12], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Violet':          {atk:[110,22], crit:[45,22], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  ...
  'Crow':            {atk:[110,22], crit:[42,20], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Howler':          {atk:[110,20], crit:[40,18], cdmg:[0,0],   dmgMulti:[50,22], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'J&C':             {atk:[110,22], crit:[38,18], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Noir':            {atk:[110,22], crit:[38,18], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Messa':           {atk:[100,22], crit:[35,18], cdmg:[0,0],   dmgMulti:[50,20], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'makoto':          {atk:[110,22], crit:[42,20], cdmg:[185,15], dmgMulti:[35,12], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'closer-tropical': {atk:[70,15],  crit:[25,12], cdmg:[0,0],   dmgMulti:[0,0],   hp:[110,25],def:[0,0],   heal:[0,0],  spd:[0,0]},
  'rin-firecracker': {atk:[110,20], crit:[40,18], cdmg:[0,0],   dmgMulti:[50,22], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  ...
  'Bui':             {atk:[100,22], crit:[45,25], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Closer':          {atk:[85,22],  crit:[32,15], cdmg:[0,0],   dmgMulti:[45,15], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Mont':            {atk:[85,22],  crit:[38,18], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  'Sepia':           {atk:[80,22],  crit:[0,0],   cdmg:[0,0],   dmgMulti:[0,0],   hp:[65,15], def:[0,0],   heal:[0,0],  spd:[30,18]},
  'Fleuret':         {atk:[85,22],  crit:[38,18], cdmg:[185,15], dmgMulti:[0,0],   hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0]},
  // ── ELUCIDATOR ──
  ...
  'wind-tempest':    {atk:[75,10],  crit:[0,0],   cdmg:[388,25], dmgMulti:[0,0],  hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0],    spr:[525,22], ailm:[0,0]},
  ...
  'Matoi':           {atk:[40,8],   crit:[0,0],   cdmg:[0,0],   dmgMulti:[25,10], hp:[0,0],   def:[0,0],   heal:[0,0],  spd:[0,0],   ailm:[199,25]},
