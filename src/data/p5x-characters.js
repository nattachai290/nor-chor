export const CHARACTERS = [
  ...
  {name:'Wind (Tempest)', codename:'wind-tempest', role:'Strategist', element:'Wind', rarity:5,
    ...
    statTargets: {
      'LV10':    {atk:[0,0], crit:[42,18], cdmg:[388,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[132,8], spr:[525,22], ailm:[0,0]},
      'LV10+M5': {atk:[0,0], crit:[42,18], cdmg:[388,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[132,8], spr:[525,22], ailm:[0,0]},
