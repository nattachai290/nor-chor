export const CHARACTERS = [
  ...
  {name:'Matoi',              codename:'Matoi',          role:'Saboteur',   element:'Ice',            rarity:5, cards:['Futility 4pc'],                 weapon:'Best Ice Saboteur weapon',                      statPrio:['Ailment Accuracy'],                              note:'Ice Saboteur. Provides party-wide damage mitigation and debuffs.',
    ...
    skills:[
      ...
      {name:'Extinguishing Guidance', type:'Skill',   element:'Ice', sp:25,
        desc:"Can be used at 2 or more Extinguish stacks. Spend 2 Extinguish stacks to deal Ice damage to all foes equal to 109.8%/121.0%/116.6%/127.8% of Attack. Also, decrease Defense by 7.3%/8.1%/7.8%/8.5% for 2 turns (for every 5.83% of Natsukawa's ailment accuracy, decrease Defense by 1% more, up to a maximum of 29.3%/32.3%/31.1%/34.1%).\nAlso, can activate Ice Technical. When Iceburn is activated, this effect is guaranteed to evolve to Cold Flames.\nCold Flames: Increase damage taken by 9.8%/10.8%/10.4%/11.4% (for every 4.38% of Natsukawa's ailment accuracy, increase damage taken by 1% more, up to a maximum of 39.0%/43.0%/41.4%/45.4%).\nAt 4 or more Extinguish stacks, evolve this skill to Requiem Guidance. Spend 4 Extinguish stacks to deal Ice damage to all foes equal to 131.8%/145.3%/139.9%/153.4% of Attack. Also, decrease Defense by 8.8%/9.7%/9.3%/10.2% for 2 turns (for every 4.86% of Natsukawa's ailment accuracy, decrease Defense by 1% more, up to a maximum of 35.1%/38.7%/37.3%/40.9%). Also, can activate Ice Technical. When Iceburn is activated, this effect is guaranteed to evolve to Cold Flames.\nCold Flames: Increase damage taken by 11.7%/12.9%/12.4%/13.6% (for every 3.65% of Natsukawa's ailment accuracy, increase damage taken by 1% more, up to a maximum of 46.8%/51.6%/49.7%/54.5%).",
        descTh:"ใช้ได้เมื่อมี Extinguish stack 2 ขึ้นไป ใช้ 2 stack สร้างความเสียหายธาตุน้ำแข็งให้ศัตรูทุกตัว เท่ากับ 109.8%/121.0%/116.6%/127.8% ของ Attack ลด DEF ศัตรู 7.3%/8.1%/7.8%/8.5% 2 เทิร์น (ต่อ ailment accuracy ของ Natsukawa 5.83% ลด DEF เพิ่ม 1% สูงสุด 29.3%/32.3%/31.1%/34.1%)\nสามารถเปิดใช้ Ice Technical เมื่อ Iceburn ถูกเปิดใช้ เอฟเฟกต์จะพัฒนาเป็น Cold Flames เสมอ\nCold Flames: เพิ่มความเสียหายที่รับ 9.8%/10.8%/10.4%/11.4% (ต่อ ailment accuracy ของ Natsukawa 4.38% เพิ่มเติม 1% สูงสุด 39.0%/43.0%/41.4%/45.4%)\nเมื่อมี Extinguish stack 4 ขึ้นไป พัฒนาเป็น Requiem Guidance ใช้ 4 stack สร้างความเสียหายธาตุน้ำแข็งให้ศัตรูทุกตัว เท่ากับ 131.8%/145.3%/139.9%/153.4% ของ Attack ลด DEF 8.8%/9.7%/9.3%/10.2% 2 เทิร์น (ต่อ ailment accuracy ของ Natsukawa 4.86% ลด DEF เพิ่ม 1% สูงสุด 35.1%/38.7%/37.3%/40.9%) สามารถเปิดใช้ Ice Technical เมื่อ Iceburn ถูกเปิดใช้ เอฟเฟกต์จะพัฒนาเป็น Cold Flames เสมอ\nCold Flames: เพิ่มความเสียหายที่รับ 11.7%/12.9%/12.4%/13.6% (ต่อ ailment accuracy ของ Natsukawa 3.65% เพิ่มเติม 1% สูงสุด 46.8%/51.6%/49.7%/54.5%)"},
      {name:'HIGHLIGHT',              type:'Skill',   element:'Ice', sp:0,
    ...
    statTargets: {
      'LV10'   : {atk:[40,8], crit:[0,0], cdmg:[0,0], dmgMulti:[25,10], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[0,0], ailm:[188,25]},
      'LV10+M5': {atk:[40,8], crit:[0,0], cdmg:[0,0], dmgMulti:[25,10], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[0,0], ailm:[188,25]},
  ...
  {name:'Wind (Tempest)', codename:'wind-tempest', role:'Strategist', element:'Wind', rarity:5,
    ...
    statPrio:['Crit Mult.','SP Recovery'], note:'Wind Strategist. CRIT DMG-scaling buffs — all party ATK/CRIT DMG buffs scale with her own CRIT multiplier. SP starts full each battle — open with Blossoming Season immediately. Space card: Creation (Worry passive → CRIT DMG +45% เมื่อ SPR ≥ 200%). SPR target 525% (max) = Storm of Petals 2 casts เติม SP ครบ 200 พอดี; 450% = min (Sun-kissed Blooms cap). Main stats: Star→Crit Mult (+37.6%), Sky→SPR (+90.4%), Moon→ATK% (ไม่มี option ที่ scale buff โดยตรง). Speed ใช้ sub stat เท่านั้น (~28 จาก card).',
    mechanics: "ATK buff และ CRIT DMG buff ทั้งหมดของ Riko สเกลตาม CRIT multiplier ของตัวเองที่เกิน 100% — ทุก 10% CRIT DMG ที่เกิน คูณค่าบัฟทุกอย่าง Blossoming Season ใช้ SP ทั้งหมด (ต่ำสุด 50, สูงสุด 200) เพื่อผล tier: SP 50+ ให้ ATK buff, SP 100+ เพิ่ม CRIT DMG buff, SP 150+ เพิ่ม CRIT DMG อีก — ยิ่งใช้ SP มากยิ่งแรง SP เต็มตั้งแต่เริ่มเกม, Storm of Petals ฟื้น SP ตามสูตร 16×(1+SPR/100) ที่ SPR 525%: 2 casts = 200 SP พอดีเติม max ทุกรอบ Worry 4pc + Creation Space card: Worry passive +45% CRIT DMG ที่ SPR 525% ซึ่งได้ตลอด — CRIT DMG ก้อนนี้ scale ทุก buff โดยตรง",
    rotation: [
      "R1: Blossoming Season → SP เต็ม 200 buff DPS หลัก ATK+CRIT DMG+CRIT Rate ทันที",
      "R2: Storm of Petals → ได้ SP 88 (SPR 525%)",
      "R3: Storm of Petals → SP รวม 176–200 (150+ tier พร้อม)",
      "R4: Blossoming Season → dump SP buff DPS หลักอีกรอบ",
      "วน R2–R4 ซ้ำ",
    ],
    realName:'Tempest Riko', persona:'Chiyome',
    combatBuffs:[
      {name:'Sun-kissed Blooms', type:'sunKissedB',    note:'CRIT DMG สเกลตาม SPR (สูงสุด +84% ที่ SPR 450%)'},
      {name:'Creation & Worry',  type:'spacePassiveB', note:'SPR ≥ 200%: CRIT DMG +45% (Worry 4pc + Creation Space card)'},
    ],
    weakRes:{ Fire:'normal', Ice:'normal', Electric:'normal', Wind:'res', Nuclear:'normal',
      Curse:'normal', Bless:'normal', Physical:'normal', Almighty:'normal', Psychokinesis:'wk' },
    skills:[
    ...
    statTargets: {
      'LV10':    {atk:[75,10], crit:[0,0], cdmg:[388,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[525,22], ailm:[0,0]},
      'LV10+M5': {atk:[75,10], crit:[0,0], cdmg:[388,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[525,22], ailm:[0,0]},
      'LV13':    {atk:[75,10], crit:[0,0], cdmg:[418,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[525,22], ailm:[0,0]},
      'LV13+M5': {atk:[75,10], crit:[0,0], cdmg:[418,25], dmgMulti:[0,0], hp:[0,0], def:[0,0], heal:[0,0], spd:[0,0], spr:[525,25], ailm:[0,0]},
    },
    statFloor: {spr: 450},
    mindscapeBonus: {atk:20, cdmg:24},
  },
...
export const SKILL_TYPE_IMG = { Passive: import.meta.env.BASE_URL + 'p5x/elements/passive.webp' }

export const BASE = import.meta.env.BASE_URL + 'p5x/roles/'
export const ROLE_IMG = {
...
export const BASE_ELEM = import.meta.env.BASE_URL + 'p5x/elements/'
export const ELEM_IMG = {
...
export const BASE_PORTRAITS = import.meta.env.BASE_URL + 'p5x/portraits/'
...
export const RAINBOW_CHARS = new Set(['Violet','Oracle','Chord','Ange','Queen','Crow','Matoi','J&C','Noir','Messa','makoto','closer-tropical','rin-firecracker','mont-frostgale','wind-tempest','moko-seaside'])
