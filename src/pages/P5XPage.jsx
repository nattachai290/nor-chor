...
const CHARACTERS = [
  ...
  {name:'Ryuji Sakamoto', codename:'Skull', role:'Assassin', element:'Physical', rarity:5,
    ...
    baseStats: {hp:352, atk:97, def:47, spd:94, crit:5, cdmg:150, meleeMulti:120, rangedMulti:55.4, rangedAcc:84, rangedCrit:19.05},
    baseStatsLv80: [
  ...
  {name:'Yaoling Li',         codename:'Rin',            role:'Saboteur',   element:'Curse',          rarity:5, cards:['Hindrance 4pc','Strife 2pc'],   weapon:'Best Curse / SPD weapon',                       statPrio:['Attack %','Speed','Defense %'],                             note:'Best enemy debuffer — reduces enemy DEF. Hindrance 4pc amplifies debuffed targets.',
    ...
    baseStats:     {hp:283, atk:97, def:56, spd:106, crit:5, cdmg:150, meleeMulti:115, rangedMulti:14.8, rangedAcc:78, rangedCrit:5.13},
    baseStatsLv80: [
  ...
  {name:'Wind (Tempest)', codename:'wind-tempest', role:'Strategist', element:'Wind', rarity:5,
    ...
    baseStats: {hp:323, atk:87, def:56, spd:104, crit:5, cdmg:150, sp:200, meleeMulti:125, rangedMulti:49.9, rangedAcc:75, rangedCrit:16},
    baseStatsLv80: [
