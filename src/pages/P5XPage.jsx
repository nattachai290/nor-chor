...
const CHARACTERS = [
  ...
  {name:'Wind (Tempest)', codename:'wind-tempest', role:'Strategist', element:'Wind', rarity:5,
    cards:['Worry 2pc','Reconciliation 2pc'], weapon:'Best CRIT DMG/Support weapon (Windplum Dance)',
    ...
    rotation: [
      ...
      "ใช้ Highlight → ATK + CRIT DMG buff พันธมิตร 1 คน (สเกลตาม CRIT multiplier ของ Riko); ใช้ก่อนช่วง burst ของ DPS",
